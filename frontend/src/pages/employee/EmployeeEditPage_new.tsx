...
const EmployeeEditPage = () => {
  ...
  const { employee, loading, error, updateEmployee, saving, fetchEmployee } = useEmployee({ 
    employeeId: '', // 不自动获取 
    autoFetch: false 
  });
  ...
  const handleSubmit = async (data: any) => {
    ...
    if (success) {
      ...
      setTimeout(() => {
        navigate(`/employees/${id}/detail-new`);
      }, 1000);
    }
  };
    ...
    <>
      ...
      <div className="container mx-auto p-4 max-w-4xl">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold">编辑员工: {employee.full_name}（新版本）</h1>
        </div>

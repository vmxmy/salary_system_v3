...
export const MoneyIcon: React.FC<IconProps> = ({ className = "text-2xl" }) => (
  <span className={className}>💰</span>
);

export const BankIcon: React.FC<IconProps> = ({ className = "text-2xl" }) => (
  <span className={className}>🏦</span>
);

export const PeopleIcon: React.FC<IconProps> = ({ className = "text-2xl" }) => (
  <span className={className}>👥</span>
);

export const BriefcaseIcon: React.FC<IconProps> = ({ className = "text-2xl" }) => (
  <span className={className}>💼</span>
);